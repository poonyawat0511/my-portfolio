...
export default function ProjectInfoCard({
  ...
  return (
    <Card
      isBlurred
      className="relative overflow-hidden border-none bg-background/60 dark:bg-default-100/50 max-w-[700px]"
      shadow="sm"
    >
      <CardBody>
        <div className="flex flex-col gap-2">
          ...
          {/* Wrap motion area to clip its scale animation as well */}
